...
const AboutUs = () => {
  return (
    <div className="w-full bg-white flex flex-col items-center relative overflow-hidden">
      ...
      <div className="w-full bg-gradient-to-r min-h-[40vh] from-blue-100 to-teal-100 flex flex-col md:flex-row items-center justify-between rounded-none shadow-lg">
        {/* Left Content */}
