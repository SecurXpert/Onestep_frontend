...
//   const [selectedSlots, setSelectedSlots] = useState({}); // Track selected slot for each doctor
 
//   const handleSlotClick = (doctorId, slot) => {
//     setSelectedSlots((prev) => ({
//       ...prev,
//       [doctorId]: slot, // Store selected slot for this doctor
//     }));
...
//                       const isSelected =
//                         selectedSlots[doctor.doctor_id] === slot ||
//                         (patientInfo.optionalDoctorId === doctor.doctor_id &&
//                           patientInfo.alternativeTime === slot);
//                       return (
//                         <button
